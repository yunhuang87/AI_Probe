...
from .conversation_agent import conversation_agent, IntentAnalysis
...
class OrchestrationEngine:
    ...
    async def orchestrate_request(
        ...
        try:
            ...
            is_sap_query = any(keyword in user_input.lower() for keyword in sap_keywords) or \
                         any(tool == "sap_query" for tool in intent_analysis.required_tools)
