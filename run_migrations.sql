...
CREATE TABLE IF NOT EXISTS agent_nodes (
    id VARCHAR PRIMARY KEY,
    workflow_id VARCHAR NOT NULL REFERENCES workflow_definitions(id),
...
CREATE INDEX IF NOT EXISTS idx_agent_nodes_workflow_id ON agent_nodes(workflow_id);
CREATE INDEX IF NOT EXISTS idx_agent_nodes_agent_id ON agent_nodes(agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_contexts_conversation_id ON agent_contexts(conversation_id);
CREATE INDEX IF NOT EXISTS idx_agent_contexts_agent_id ON agent_contexts(agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_execution_records_agent_id ON agent_execution_records(agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_execution_records_workflow_id ON agent_execution_records(workflow_id);
