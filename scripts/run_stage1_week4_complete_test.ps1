# 阶段一第4周完整测试脚本 - 统一意图服务增强

$ErrorActionPreference = "Stop"

Write-Host "========================================" -ForegroundColor Green
Write-Host "  阶段一第4周完整测试流程" -ForegroundColor Green
Write-Host "  统一意图服务增强" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
python -m pytest tests/test_stage1_week4.py -v --no-cov --tb=short -s
...
if ($TEST_EXIT_CODE -eq 0) {
    ...
    Write-Host "  [OK] 统一意图服务测试" -ForegroundColor White
    Write-Host "  [OK] 意图理解功能" -ForegroundColor White
    Write-Host "  [OK] 活动推荐功能" -ForegroundColor White
    Write-Host "  [OK] 缓存功能" -ForegroundColor White
    Write-Host "  [OK] 性能测试" -ForegroundColor White
    Write-Host ""
    Write-Host "[OK] 可以进入第5周！" -ForegroundColor Green
} else {
    Write-Host "[ERROR] 测试失败，请检查错误信息" -ForegroundColor Red
    Write-Host "[ERROR] 不能进入第5周" -ForegroundColor Red
}
Write-Host "========================================" -ForegroundColor Green
