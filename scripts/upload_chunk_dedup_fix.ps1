# Upload chunk deduplication fix to server
...
Write-Host "Uploading chunk deduplication fix" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
# Restart web-ui
Write-Host "`nRestarting web-ui..." -ForegroundColor Yellow
try {
