# Upload overall display optimization
...
Write-Host "Uploading overall display optimization" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "`nNote: Please refresh the browser page after rebuild completes to see the optimized overall display." -ForegroundColor Yellow
Write-Host "`n"
