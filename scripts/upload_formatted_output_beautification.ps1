# Upload formatted output beautification
...
Write-Host "Uploading formatted output beautification" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "`nNote: Please refresh the browser page after rebuild completes to see the beautified formatted output." -ForegroundColor Yellow
Write-Host "`n"
